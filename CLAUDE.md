...
(cd client-linux && cargo fmt --check && cargo clippy --all-targets -- -D warnings && cargo test && cargo build --release)   # the Linux client's contract (CI runs it in fedora:44)
