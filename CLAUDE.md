...
9. **The guard** (per-IP limits, escalating bans, global breaker — §12) is config-driven and never disabled or special-cased in production code paths. Tests inject clocks and config; they do not add bypasses.
