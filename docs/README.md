...
| ------------------------------------------------------------ | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [deploy/README.md](../deploy/README.md)                      | M0, M5, M7, M8 | Production and local (internal CA) deployment; backups and verified restore; restoring for real; the Postgres image pin and major-version upgrades; extension distribution                   |
| [runbooks/domain-migration.md](runbooks/domain-migration.md) | M8             | Moving to a new hostname: DNS precondition, old-domain 308, the one-variable change, extension rebuild/re-sign, redirect lifetime, rollback — rehearsed by `deploy/test-domain-migration.sh` |
...
| [supply-chain.md](supply-chain.md)                           | M7, M8         | `pnpm audit` gate and reviewed exceptions, Trivy image scans, Dependabot grouping and ignore policy, pins                                                                                    |
