...
| #   | Check                                                                                                                                                                                                                                                                                                                | Chrome                                                                                            | Firefox    |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------- |
| 3.1 | No token saved → clicking Visible opens the options page and shows a notification "Add your server address and API token…"; popup shows the same text                                                                                                                                                                | unverified (code path unit-covered)                                                               | unverified |
| 3.2 | Revoke the token on `/account`, capture again → notification "The server rejected the API token…" and the options page opens (401 path)                                                                                                                                                                              | unverified                                                                                        | unverified |
| 3.3 | Stop the server, capture → notification "Could not reach http://localhost:3000…"                                                                                                                                                                                                                                     | unverified                                                                                        | unverified |
| 3.4 | Restricted pages: `chrome://extensions`, `about:debugging`, `about:blank`, `view-source:`, a `file://` page, `chromewebstore.google.com`, `addons.mozilla.org` → popup opens with "Can't capture this page: …" and **all** buttons disabled; the shortcut on those pages produces the same message as a notification | verified for `chrome-extension://` (Playwright + e2e); others unit-covered, unverified in-browser | unverified |
